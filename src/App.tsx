...
import { ThesisEvaluationView } from './components/ThesisEvaluationView.tsx';
import { CapiSandboxView } from './components/CapiSandboxView.tsx';
import { AbideBlueprintView } from './components/AbideBlueprintView.tsx';
import { SkillRegistryView } from './components/SkillRegistryView.tsx';
import { GnomledgerExplorerView } from './components/GnomledgerExplorerView.tsx';
import { VnpTelemetryView } from './components/VnpTelemetryView.tsx';
import { RbacPolicyView } from './components/RbacPolicyView.tsx';
import { ApiDocsView } from './components/ApiDocsView.tsx';
import { GlobalQuickActionModal } from './components/GlobalQuickActionModal.tsx';
import { SystemMode, UserRole, SkillSpec, OllamaStatus } from './types.ts';
import { INITIAL_SKILLS_REGISTRY } from './server/repogate-scanner.ts';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      {/* Global Quick Action Command Palette Modal */}
